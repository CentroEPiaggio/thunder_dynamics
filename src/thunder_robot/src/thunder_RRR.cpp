...
// constexpr std::string path_yaml_DH_REG = "../RRRs/franka/generatedFiles/inertial_REG_stored";
// constexpr std::string path_copy_DH_REG = "../RRRs/franka/generatedFiles/inertial_REG_stored_copy";
...
namespace thunder_ns{
	...
	int thunder_RRR::get_numJoints() {return num_joints;};
	...
	// Other functions
	void thunder_RRR::fillInertialYaml(int num_joints, YAML::Emitter &emitter_, std::vector<LinkProp> &links_prop_, std::vector<std::string> keys_){
		YAML::Node control;
