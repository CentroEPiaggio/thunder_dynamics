#include "thunder_R3.h"
#include "R3_gen.h"

// constexpr std::string path_yaml_DH_REG = "../R3s/franka/generatedFiles/inertial_REG_stored";
// constexpr std::string path_copy_DH_REG = "../R3s/franka/generatedFiles/inertial_REG_stored_copy";
...
namespace thunder_ns{
	...
	thunder_R3::thunder_R3(){
		num_joints = N_JOINTS;
		resizeVariables();
	}

	void thunder_R3::resizeVariables(){
	...
	int thunder_R3::get_numJoints() {return num_joints;};
	int thunder_R3::get_numParams() {return par_REG.size();};
	
	void thunder_R3::setArguments(const Eigen::VectorXd& q_, const Eigen::VectorXd& dq_, const Eigen::VectorXd& dqr_, const Eigen::VectorXd& ddqr_){
	...
	void thunder_R3::update_inertial_DYN(){
	...
	void thunder_R3::update_inertial_REG(){
		for (int i=0; i<num_joints; i++){
	...
	void thunder_R3::set_inertial_REG(const Eigen::VectorXd& par_){
	...
	void thunder_R3::set_inertial_DYN(const Eigen::VectorXd& par_){
		if(par_.size() == N_PAR_LINK*num_joints){
			par_DYN = par_;
		} else{
			std::cout<<"in setArguments: invalid dimensions of arguments\n";
	...
	Eigen::VectorXd thunder_R3::get_inertial_REG(){
		return par_REG;
	}

	Eigen::VectorXd thunder_R3::get_inertial_DYN(){
		return par_DYN;
	}

	void thunder_R3::load_inertial_REG(std::string file_path){
		try {
	...
	void thunder_R3::load_inertial_DYN(std::string file_path){
		try {
			YAML::Node config = YAML::LoadFile(file_path);
	...
	void thunder_R3::save_inertial_REG(std::string path_yaml_DH_REG){
	...
	void thunder_R3::save_inertial_DYN(std::string path_yaml_DH_DYN){
		std::vector<std::string> keys_reg;
		keys_reg.resize(5);
	...
	// Other functions
	void thunder_R3::fillInertialYaml(int num_joints, YAML::Emitter &emitter_, std::vector<LinkProp> &links_prop_, std::vector<std::string> keys_){
		YAML::Node control;
    ...
    Eigen::Matrix3d thunder_R3::hat(const Eigen::Vector3d v){
        Eigen::Matrix3d vhat;
    ...
    Eigen::Matrix3d thunder_R3::rpyRot(const std::vector<double> rpy){
    ...
    Eigen::Matrix3d thunder_R3::createI(const std::vector<double> parI){
        Eigen::Matrix3d I;
        I(0, 0) = parI[0];
        I(0, 1) = parI[1];
        I(0, 2) = parI[2];
	...
	Eigen::MatrixXd thunder_R3::get_C(){
		Eigen::MatrixXd out;
		out.resize(3,3);
	...
	Eigen::MatrixXd thunder_R3::get_C_std(){
		Eigen::MatrixXd out;
		out.resize(3,3);
	...
	Eigen::MatrixXd thunder_R3::get_G(){
		Eigen::MatrixXd out;
		out.resize(3,1);
	...
	// - Jacobian of frame 0 - //
	Eigen::MatrixXd thunder_R3::get_J_0(){
		Eigen::MatrixXd out;
		out.resize(6,3);
	...
	// - Jacobian of frame 1 - //
	Eigen::MatrixXd thunder_R3::get_J_1(){
		Eigen::MatrixXd out;
		out.resize(6,3);
	...
	// - Jacobian of frame 2 - //
	Eigen::MatrixXd thunder_R3::get_J_2(){
		Eigen::MatrixXd out;
		out.resize(6,3);
	...
	// - Jacobian of frame 3 - //
	Eigen::MatrixXd thunder_R3::get_J_3(){
		Eigen::MatrixXd out;
		out.resize(6,3);
	...
	Eigen::MatrixXd thunder_R3::get_J_cm_0(){
		Eigen::MatrixXd out;
		out.resize(6,3);
	...
	Eigen::MatrixXd thunder_R3::get_J_cm_1(){
		Eigen::MatrixXd out;
		out.resize(6,3);
	...
	Eigen::MatrixXd thunder_R3::get_J_cm_2(){
		Eigen::MatrixXd out;
		out.resize(6,3);
	...
	Eigen::MatrixXd thunder_R3::get_J_ee(){
		Eigen::MatrixXd out;
		out.resize(6,3);
	...
	Eigen::MatrixXd thunder_R3::get_J_ee_dot(){
		Eigen::MatrixXd out;
		out.resize(6,3);
	...
	Eigen::MatrixXd thunder_R3::get_J_ee_pinv(){
		Eigen::MatrixXd out;
		out.resize(3,6);
	...
	Eigen::MatrixXd thunder_R3::get_M(){
		Eigen::MatrixXd out;
		out.resize(3,3);
	...
	Eigen::MatrixXd thunder_R3::get_T_0(){
		Eigen::MatrixXd out;
		out.resize(4,4);
	...
	Eigen::MatrixXd thunder_R3::get_T_0_0(){
		Eigen::MatrixXd out;
		out.resize(4,4);
	...
	Eigen::MatrixXd thunder_R3::get_T_0_1(){
		Eigen::MatrixXd out;
		out.resize(4,4);
	...
	Eigen::MatrixXd thunder_R3::get_T_0_2(){
		Eigen::MatrixXd out;
		out.resize(4,4);
	...
	Eigen::MatrixXd thunder_R3::get_T_0_3(){
		Eigen::MatrixXd out;
		out.resize(4,4);
	...
	Eigen::MatrixXd thunder_R3::get_T_0_ee(){
		Eigen::MatrixXd out;
		out.resize(4,4);
	...
	Eigen::MatrixXd thunder_R3::get_T_1(){
		Eigen::MatrixXd out;
		out.resize(4,4);
	...
	Eigen::MatrixXd thunder_R3::get_T_2(){
		Eigen::MatrixXd out;
		out.resize(4,4);
	...
	Eigen::MatrixXd thunder_R3::get_Yr(){
		Eigen::MatrixXd out;
		out.resize(3,30);
	...
	Eigen::MatrixXd thunder_R3::get_reg_C(){
		Eigen::MatrixXd out;
		out.resize(3,30);
	...
	Eigen::MatrixXd thunder_R3::get_reg_G(){
		Eigen::MatrixXd out;
		out.resize(3,30);
	...
	Eigen::MatrixXd thunder_R3::get_reg_M(){
		Eigen::MatrixXd out;
		out.resize(3,30);
