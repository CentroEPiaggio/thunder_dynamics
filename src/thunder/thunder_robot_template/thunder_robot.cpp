...
PYBIND11_MODULE(thunder_robot_py, m) {
	py::class_<thunder_robot>(m, "Thunderrobot")
		...
		.def("set_par_REG", &thunder_robot::set_par_REG, "Set inertial parameters REG", py::arg("par"))
		.def("set_par_DYN", &thunder_robot::set_par_DYN, "Set inertial parameters DYN", py::arg("par"))
		...
		.def("load_par_REG", &thunder_robot::load_par_REG, "Load par parameters REG from YAML file", py::arg("file_path"))
		.def("save_par_REG", &thunder_robot::save_par_REG, "Save par parameters REG to YAML file", py::arg("file_path"))
		.def("load_par_DYN", &thunder_robot::load_par_DYN, "Load par parameters DYN from YAML file", py::arg("file_path"))
