...
PYBIND11_MODULE(thunder_robot_py, m) {
	py::class_<thunder_robot>(m, "Thunderrobot")
		...
		.def("set_inertial_REG", &thunder_robot::set_inertial_REG, "Set inertial parameters REG", py::arg("par"))
		.def("set_inertial_DYN", &thunder_robot::set_inertial_DYN, "Set inertial parameters DYN", py::arg("par"))
		.def("get_inertial_REG", &thunder_robot::get_inertial_REG, "Get inertial parameters REG")
		.def("get_inertial_DYN", &thunder_robot::get_inertial_DYN, "Get inertial parameters DYN")
		.def("load_inertial_REG", &thunder_robot::load_inertial_REG, "Load inertial parameters REG from YAML file", py::arg("file_path"))
		.def("save_inertial_REG", &thunder_robot::save_inertial_REG, "Save inertial parameters REG to YAML file", py::arg("file_path"))
		.def("load_inertial_DYN", &thunder_robot::load_inertial_DYN, "Load inertial parameters DYN from YAML file", py::arg("file_path"))
		.def("save_inertial_DYN", &thunder_robot::save_inertial_DYN, "Save inertial parameters DYN to YAML file", py::arg("file_path"))
		.def("get_numJoints", &thunder_robot::get_numJoints, "Get number of joints")
		.def("get_numParLink", &thunder_robot::get_numParLink, "Get number of parameters per link")
		.def("get_numParams", &thunder_robot::get_numParams, "Get number of parameters")
